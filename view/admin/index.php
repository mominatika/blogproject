                        ...
                        <?php if(isset($data['user']))
                                {
                                    ...
                                    {
                                        if($status=$users[$i]->userStatus == 'active')
                                        {
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <a href="<?php echo ROOT;?>allUsers/AllUsers"><div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Users</div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                               Post</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $data['allBlog'];?></div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $activeUser; ?></div>
                                                </div>
                                                <div class="col">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                inactive User</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $inactiveUser; ?></div>
                                        </div>
                                        <div class="col-auto">
